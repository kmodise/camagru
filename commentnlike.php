...
class commentnlike{
    ...
    {
        try{
            $sql = 'INSERT INTO comments (userid, useridown, comment, imagenu)
                    VALUES ( :userid, :useridown, :comment, :imagenu)';
    ...
    {
        try{
            $sql = 'INSERT INTO likes (userid, useridown, imagenu)
                    VALUES ( :userid, :useridown, :imagenu)';
            $aa = $this->conns->prepare($sql);
            $aa->bindParam(':userid', $userid);
            $aa->bindParam(':useridown', $useridown);
            // $aa->bindParam(':timess', date("U"));
